                ...
                <div className="flex flex-wrap md:text-left text-center -mb-10 -mx-4">
                    ...
                    <div className="lg:w-1/4 md:w-1/2 w-full px-4">
                        ...
                        <nav className="list-none mb-10">
                            <li>
                                <a href="#" className="text-gray-400 hover:text-white">Funny Jokes</a>
                            </li>
                            <li>
                                <a href="#" className="text-gray-400 hover:text-white">Dad Jokes</a>
                            </li>
                            <li>
                                <a href="#" className="text-gray-400 hover:text-white">Knock-Knock Jokes</a>
                            </li>
                            <li>
                                <a href="#" className="text-gray-400 hover:text-white">Puns</a>
                            </li>
                    ...
                    <div className="lg:w-1/4 md:w-1/2 w-full px-4">
                        ...
                        <nav className="list-none mb-10">
                            ...
                            <li>
                                <a href="/joke" className="text-gray-400 hover:text-white">Jokes</a>
                            </li>
                            <li>
                                <a href="/memes" className="text-gray-400 hover:text-white">Memes</a>
                            </li>
                            <li>
                                <a href="#" className="text-gray-400 hover:text-white">Submit Joke</a>
                            </li>
            ...
            <div className="bg-gray-800 bg-opacity-75">
                ...
                <div className="container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row">
                    ...
                    <p className="text-gray-400 text-sm text-center sm:text-left">© 2023 Joke Generator  —
                        <a href="https://twitter.com/YourTwitterHandle" className="text-gray-500 ml-1" target="_blank" rel="noopener noreferrer">@AnuragAffection</a>
                    </p>

                    <span className="sm:ml-auto sm:mt-0 mt-2 sm:w-auto w-full sm:text-left text-center text-gray-400 text-sm">A family of Love & Affection </span>
